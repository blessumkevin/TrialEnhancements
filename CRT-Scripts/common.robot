...
Login To Dev1
    [Documentation]          Logs into Dev1 environment using specific credentials
    GoTo                     test.salesforce.com
    TypeText                Username                    kblessum@fonterra.com.dev1
    TypeSecret              Password                    ${password}
    ClickText               Log In
    VerifyText             Home                        timeout=20
